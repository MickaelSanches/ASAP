...
const ContactForm = () => {
    ...
    return (
        <div className="container mx-auto p-8">
            <h2 className="tracking-wider text-2xl mb-4 text-center text-rose">CONTACTEZ-NOUS</h2>
            <form onSubmit={handleSubmit} className="max-w-lg mx-auto bg-white shadow-lg p-8">
                <div className="mb-4">
                ...
                <div className="text-center">
                    <button 
                        type="submit" 
                        className="bg-rose hover:bg-violet text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline border-0">
                        Envoyer
                    </button>
                </div>
