...
const Header = () => {
    ...
    <header className="bg-noir text-white p-2 flex justify-between items-center z-50 relative">
        ...
        <nav className="hidden md:flex space-x-4 text-white text-sm mr-4">
        ...
        <nav
            className={`absolute right-0 mt-2 w-40 bg-white shadow-lg rounded-lg py-2 transform transition duration-300 ease-in-out z-50 ${
